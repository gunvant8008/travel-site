...
class ClientArea {
  constructor() {
    ...
    this.field = document.querySelector(".client-aea__input")
  ...
  sendRequest() {
    Axios.post("https://sunny-croquembouche-c62a3e.netlify.app/.netlify/functions/secret-area", { password: this.field.value })
      .then(response => {
        this.form.remove()
